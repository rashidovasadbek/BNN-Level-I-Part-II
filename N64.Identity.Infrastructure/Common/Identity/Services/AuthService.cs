...
namespace N64.Identity.Infrastructure.Common.Idenitty.Servises;
...
public class AuthService : IAuthService
{
    ...
    {
        var foundUser = _users.FirstOrDefault(user => user.EmailAddress == loginDetails.EmailAddress && _passwordHasherService.ValidatePassword(loginDetails.Password, user.Password));
